...
type Pancake struct {
	...
	// シェフの名前
	ChefName string `protobuf:"bytes,2,opt,name=chef_name,json=chefName,proto3" json:"chef_name,omitempty"`
	// メニュー
	Menu Pancake_Menu `protobuf:"varint,3,opt,name=menu,proto3,enum=pancake.baker.Pancake_Menu" json:"menu,omitempty"`
	// 焼き具合を表すスコアです(0-0.9)
	TechnicalScore float32 `protobuf:"fixed32,5,opt,name=technical_score,json=technicalScore,proto3" json:"technical_score,omitempty"`
	// 焼いた日時
...
var fileDescriptor_bd84accc06629c9d = []byte{
	...
	,
}
