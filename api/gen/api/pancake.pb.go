...
type NotifiyBakedRequest struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *NotifiyBakedRequest) Reset()         { *m = NotifiyBakedRequest{} }
func (m *NotifiyBakedRequest) String() string { return proto.CompactTextString(m) }
func (*NotifiyBakedRequest) ProtoMessage()    {}
func (*NotifiyBakedRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd84accc06629c9d, []int{6}
}

func (m *NotifiyBakedRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_NotifiyBakedRequest.Unmarshal(m, b)
}
func (m *NotifiyBakedRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_NotifiyBakedRequest.Marshal(b, m, deterministic)
}
func (m *NotifiyBakedRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NotifiyBakedRequest.Merge(m, src)
}
func (m *NotifiyBakedRequest) XXX_Size() int {
	return xxx_messageInfo_NotifiyBakedRequest.Size(m)
}
func (m *NotifiyBakedRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_NotifiyBakedRequest.DiscardUnknown(m)
}

var xxx_messageInfo_NotifiyBakedRequest proto.InternalMessageInfo

type NotifyBakedResponse struct {
	Pancake              *Pancake `protobuf:"bytes,1,opt,name=pancake,proto3" json:"pancake,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *NotifyBakedResponse) Reset()         { *m = NotifyBakedResponse{} }
func (m *NotifyBakedResponse) String() string { return proto.CompactTextString(m) }
func (*NotifyBakedResponse) ProtoMessage()    {}
func (*NotifyBakedResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd84accc06629c9d, []int{7}
}

func (m *NotifyBakedResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_NotifyBakedResponse.Unmarshal(m, b)
}
func (m *NotifyBakedResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_NotifyBakedResponse.Marshal(b, m, deterministic)
}
func (m *NotifyBakedResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NotifyBakedResponse.Merge(m, src)
}
func (m *NotifyBakedResponse) XXX_Size() int {
	return xxx_messageInfo_NotifyBakedResponse.Size(m)
}
func (m *NotifyBakedResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_NotifyBakedResponse.DiscardUnknown(m)
}

var xxx_messageInfo_NotifyBakedResponse proto.InternalMessageInfo

func (m *NotifyBakedResponse) GetPancake() *Pancake {
	if m != nil {
		return m.Pancake
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*NotifiyBakedRequest)(nil), "pancake.baker.NotifiyBakedRequest")
	proto.RegisterType((*NotifyBakedResponse)(nil), "pancake.baker.NotifyBakedResponse")
}
...
type PancakeBakerServiceClient interface {
	...
	NotifyBaked(ctx context.Context, in *NotifiyBakedRequest, opts ...grpc.CallOption) (PancakeBakerService_NotifyBakedClient, error)
}
...
func (c *pancakeBakerServiceClient) NotifyBaked(ctx context.Context, in *NotifiyBakedRequest, opts ...grpc.CallOption) (PancakeBakerService_NotifyBakedClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PancakeBakerService_serviceDesc.Streams[0], "/pancake.baker.PancakeBakerService/NotifyBaked", opts...)
	if err != nil {
		return nil, err
	}
	x := &pancakeBakerServiceNotifyBakedClient{stream}
...
type PancakeBakerService_NotifyBakedClient interface {
	Recv() (*NotifyBakedResponse, error)
	grpc.ClientStream
}

type pancakeBakerServiceNotifyBakedClient struct {
	grpc.ClientStream
}

func (x *pancakeBakerServiceNotifyBakedClient) Recv() (*NotifyBakedResponse, error) {
	m := new(NotifyBakedResponse)
...
type PancakeBakerServiceServer interface {
	...
	// NotifyBakedはパンケーキが焼かれたら常に通知します。自分の焼いたパンケーキ以外でも通知されます。
	NotifyBaked(*NotifiyBakedRequest, PancakeBakerService_NotifyBakedServer) error
}
...
func _PancakeBakerService_NotifyBaked_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(NotifiyBakedRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(PancakeBakerServiceServer).NotifyBaked(m, &pancakeBakerServiceNotifyBakedServer{stream})
}

type PancakeBakerService_NotifyBakedServer interface {
	Send(*NotifyBakedResponse) error
	grpc.ServerStream
}

type pancakeBakerServiceNotifyBakedServer struct {
	grpc.ServerStream
}

func (x *pancakeBakerServiceNotifyBakedServer) Send(m *NotifyBakedResponse) error {
...
var _PancakeBakerService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "NotifyBaked",
			Handler:       _PancakeBakerService_NotifyBaked_Handler,
			ServerStreams: true,
		},
	},
...
var fileDescriptor_bd84accc06629c9d = []byte{
	...
	,
}
